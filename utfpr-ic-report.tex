...
Criado a base do projeto com React Native, que dá uma base para iniciar a codar, as primeiras telas e modal realizados foram a da home, login e cadastro
\begin{figure}[H]
...
\begin{figure}[H]
  ...
  Foi implementado a autentificação e a inclusão do fare base como banco de dado da aplicação, e está sendo efetuado a tela de principal e o modal de exibição dos serviços. Para a finalização do projeto pretende -se cria telas de finalização de manutenção, principal para o luarizo (onde não trabalha com manutenção) e enviar solicitação de serviço. Pretendemos fazer um teste geral do app nas últimas semanas.
